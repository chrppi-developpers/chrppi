...
########## GLOBAL TARGET PROPERTIES Debug ########################################
    ...
    set_property(TARGET Trantor::Trantor
                 ...
                 $<$<CONFIG:Debug>:${trantor_LINKER_FLAGS_DEBUG}> APPEND)
    set_property(TARGET Trantor::Trantor
                 PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Debug>:${trantor_INCLUDE_DIRS_DEBUG}> APPEND)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET Trantor::Trantor
                 PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Debug>:${trantor_LIB_DIRS_DEBUG}> APPEND)
    set_property(TARGET Trantor::Trantor
                 PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Debug>:${trantor_COMPILE_DEFINITIONS_DEBUG}> APPEND)
    set_property(TARGET Trantor::Trantor
                 PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Debug>:${trantor_COMPILE_OPTIONS_DEBUG}> APPEND)
