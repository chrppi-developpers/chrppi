...
########## GLOBAL TARGET PROPERTIES Debug ########################################
    ...
    set_property(TARGET JsonCpp::JsonCpp
                 ...
                 $<$<CONFIG:Debug>:${jsoncpp_LINKER_FLAGS_DEBUG}> APPEND)
    set_property(TARGET JsonCpp::JsonCpp
                 PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Debug>:${jsoncpp_INCLUDE_DIRS_DEBUG}> APPEND)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET JsonCpp::JsonCpp
                 PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Debug>:${jsoncpp_LIB_DIRS_DEBUG}> APPEND)
    set_property(TARGET JsonCpp::JsonCpp
                 PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Debug>:${jsoncpp_COMPILE_DEFINITIONS_DEBUG}> APPEND)
    set_property(TARGET JsonCpp::JsonCpp
                 PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Debug>:${jsoncpp_COMPILE_OPTIONS_DEBUG}> APPEND)
